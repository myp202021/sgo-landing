      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <a
            ...
            className="w-full sm:w-auto cta-primary text-lg px-12 py-4 rounded-xl"
          >
            Solicitar Demo
          </a>
          <a
            href="tel:+56226848887"
            className="w-full sm:w-auto cta-outline text-lg px-12 py-4 rounded-xl flex items-center justify-center gap-2"
          >
