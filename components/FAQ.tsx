  ...
  return (
    <section id="faq" className="py-16 md:py-20 bg-navy-light relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-teal-500/3 rounded-full blur-[120px]" />
      </div>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between px-6 py-5 text-left hover:bg-teal-500/3 transition-colors"
                >
