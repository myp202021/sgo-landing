    ...
    <section id="blog" ref={ref} className="py-16 md:py-20 bg-navy relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {articles.map((a, i) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <span className="absolute top-4 left-4 bg-teal-500/20 text-teal-400 text-xs font-semibold px-3 py-1 rounded-full border border-teal-500/20">
                  {a.category}
                </span>
              </div>
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-lg font-bold mb-3 text-off-white group-hover:text-teal-300 transition-colors leading-snug">
                  {a.title}
                </h3>
                <p className="text-slate text-sm leading-relaxed mb-4">{a.excerpt}</p>
                <span className="text-teal-400 text-sm font-medium inline-flex items-center gap-1 group-hover:gap-2 transition-all">
                  Leer mas
        ...
        <div className="text-center mt-12">
          <a
            href="/blog"
            className="inline-flex items-center gap-2 border border-teal-500/30 hover:border-teal-500/60 text-teal-400 font-medium text-sm px-6 py-3 rounded-full transition-all hover:bg-teal-500/5"
          >
