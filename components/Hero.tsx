  ...
  return (
    <section className="hero-mesh min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, rgba(32,48,56,0.7) 0%, rgba(40,80,104,0.75) 50%, rgba(32,48,56,0.95) 100%)' }} />
      </div>

      {/* Floating accent orbs */}
      <div className="absolute top-1/4 right-1/4 w-80 h-80 bg-teal-500/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-36 relative z-10 w-full">
        ...
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2.5 bg-teal-500/8 border border-teal-500/20 rounded-full px-5 py-2 mb-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            ...
            <a
              href="#productos"
              className="w-full sm:w-auto border border-white/20 hover:border-teal-500/40 text-white font-medium text-lg px-10 py-4 rounded-full transition-all hover:bg-white/5"
            >
              Ver Productos
            </a>
          </div>
