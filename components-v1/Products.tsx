...
const products = [
  {
    ...
    desc: "Canal formal y trazable para todas las comunicaciones entre mandante, contratista e inspeccion fiscal. Oficios, cartas y resoluciones con firma electronica.",
  ...
  },
  {
    ...
    tag: "Obligatorio MOP",
    desc: "Registro digital de anotaciones, observaciones e instrucciones de obra. Firma electrónica avanzada y trazabilidad completa según normativa MOP.",
  ...
  },
  {
    ...
    tag: "Validez jurídica",
    desc: "Cumple con la Ley 19.799 de Chile, garantizando autenticidad e integridad en todas las comunicaciones y documentos.",
  ...
  },
  {
    ...
    desc: "Centralización de documentos de contrato con versionamiento automatico y acceso controlado por rol.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-4">
            Una plataforma diseñada para entregar control y respaldo legal
          </h2>
          <p className="text-slate max-w-2xl mx-auto">
            Toda la información centralizada, trazable y protegida en un único ecosistema.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {products.slice(3).map((p, i) => {
            ...
            return (
              ...
              >
                <div className="absolute -top-10 -right-10 w-32 h-32 rounded-full blur-3xl pointer-events-none" style={{ background: c.glow }} />
                <div className="flex items-start gap-4 mb-4">
                  <div className={`flex-shrink-0 w-12 h-12 ${c.bg} rounded-xl flex items-center justify-center`}>
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-off-white">{p.name}</h3>
                    <span className={`inline-block text-xs font-semibold ${c.text} ${c.bg} ${c.border} border rounded-full px-3 py-0.5 mt-1`}>{p.tag}</span>
                  </div>
                </div>
                <p className="text-slate text-sm leading-relaxed">{p.desc}</p>
              </div>
